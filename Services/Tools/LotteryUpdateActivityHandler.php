...
class LotteryUpdateActivityHandler implements ToolHandlerContract
{
    public function __construct(private readonly LotteryService $service) {}

    public function __invoke(array $arguments, int $tenantId): mixed
    {
        return $this->service->updateActivity((int) $arguments['activity_id'], $arguments['name'] ?? null, $arguments['status'] ?? null);
    }
}
